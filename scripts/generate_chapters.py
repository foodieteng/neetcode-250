...
PROBLEMS = {
    ...
    '04': [  # Stack
        ...
        ('p20', 'Valid Parentheses',               'valid-parentheses',               'easy','done'),
        ('p225','Implement Stack using Queues',    'implement-stack-using-queues',    'easy','done'),
        ('p232','Implement Queue using Stacks',    'implement-queue-using-stacks',    'easy','done'),
        ('p155','Min Stack',                       'min-stack',                       'med', 'done'),
    ...
    '05': [  # Binary Search
        ...
        ('p4',   'Median of Two Sorted Arrays',            'median-of-two-sorted-arrays',            'hard','done'),
    ...
    '07': [  # Trees
        ('p94',  'Binary Tree Inorder Traversal',                            'binary-tree-inorder-traversal',                            'easy','done'),
        ('p144', 'Binary Tree Preorder Traversal',                           'binary-tree-preorder-traversal',                           'easy','done'),
        ('p145', 'Binary Tree Postorder Traversal',                          'binary-tree-postorder-traversal',                          'easy','done'),
        ('p226', 'Invert Binary Tree',                                       'invert-binary-tree',                                       'easy','done'),
        ('p104', 'Maximum Depth of Binary Tree',                             'maximum-depth-of-binary-tree',                             'easy','done'),
...
def chapter_page(cat_id, slug, title, subtitle, count):
    ...
    cheatsheet_banner = ''
    if cat_id in CHEATSHEETS:
        href, tlabel, btitle, tail = CHEATSHEETS[cat_id]
        cheatsheet_banner = (
            f'\n      <a href="{href}" style="display:flex;align-items:center;gap:14px;'
            ...
            f'{tlabel}</span>'
            f'<span style="font-weight:700;font-size:15px;">{btitle}</span>'
            '<span style="margin-left:auto;font-family:\'JetBrains Mono\',monospace;font-size:12px;'
            f'color:#e2b47a;">{tail}</span></a>'
        )
